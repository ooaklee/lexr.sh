...
| Host boundaries | `internal/hostcap`, `internal/platform` and feature-specific adapters | Conservative static host exclusions, argument-separated process execution and Docker isolation |
