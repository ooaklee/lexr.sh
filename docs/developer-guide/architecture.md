...
| Images | `internal/manager`, `internal/image`, `internal/image/ubuntu` | Source and kernel orchestration, Ubuntu remastering, structural validation and publication |
...
| Releases and repository ownership | [ADR016: kernel release preparation](../adr/adr-016-native-kernel-release-preparation.md), [ADR023: standalone naming boundary](../adr/adr-023-lexr-standalone-repository-and-compatibility.md), [ADR024: automation ownership](../adr/adr-024-lexr-owned-automation.md), [ADR025: build provenance](../adr/adr-025-submodule-safe-build-provenance.md), [ADR026: project terms](../adr/adr-026-apache-2.0-project-terms-and-release-notices.md) |
