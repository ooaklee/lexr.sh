...
The convenient path above uses the supported catalogue entry and its default
kernel release. Canonical does not publish a checksum beside the dated Ubuntu
