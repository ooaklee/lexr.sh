...
| `tools/collect-sp11-windows-bluetooth-address.ps1` | Native replacement | `tools/collect-sp11-windows-handoff.ps1` emits the strict same-device private contract consumed by `handoff import`, `handoff apply`, and `handoff restore` |
