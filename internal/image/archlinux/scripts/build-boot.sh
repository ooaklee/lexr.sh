...
chroot "$root" grub-mkstandalone -O arm64-efi --modules='part_gpt iso9660 search search_fs_file fdt linux normal configfile font gfxterm all_video efifwsetup' -o /boot/lexr-BOOTAA64.EFI boot/grub/grub.cfg=/bootstrap.cfg
