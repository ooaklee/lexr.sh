...
// installKernelPackages uses the shared offline Debian package transaction; the
// Ubuntu adapter supplies its own installed GRUB and layered-root policy.
func installKernelPackages(ctx context.Context, docker *platform.Docker, image, workspace, volume string, bundle kernel.Bundle) error {
	return debian.InstallKernelPackages(ctx, docker, image, workspace, volume, bundle)
}
