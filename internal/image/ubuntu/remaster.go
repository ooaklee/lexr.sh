...
// Result retains the original Ubuntu package name while sharing the adapter-
// neutral result contract with every image implementation.
...
// validateBundlePaths applies the shared SP11 kernel and device-tree contract.
func validateBundlePaths(bundle kernel.Bundle) error { return sp11.ValidateBundlePaths(bundle) }

// safeKernelABI retains the shared portable kernel-identity check.
func safeKernelABI(abi string) bool { return sp11.SafeKernelABI(abi) }
