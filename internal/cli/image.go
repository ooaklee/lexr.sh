...
func (a *application) newImageCreateCommand() *cobra.Command {
	...
	command := &cobra.Command{
		...
		Long:  "Create and structurally validate an experimental Surface Pro 11 ISO using the implemented Ubuntu Casper, elementary Casper, Debian Live or Fedora Live adapter.",
		Args:  cobra.NoArgs,
		RunE: func(command *cobra.Command, _ []string) error {
