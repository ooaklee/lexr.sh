...
func TestAlternateRootTouchscreenInspectionDoesNotStartHostProbes(t *testing.T) {
	...
	root := t.TempDir()
	writeAlternateHardwareFile(t, root, "/sys/firmware/devicetree/base/model", "Microsoft Surface Pro 11th Edition (OLED)\x00")
	writeAlternateHardwareFile(t, root, "/sys/firmware/devicetree/base/compatible", "microsoft,denali\x00qcom,x1e80100\x00")
