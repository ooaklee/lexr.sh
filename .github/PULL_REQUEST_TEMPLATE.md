...
- [ ] I updated the [`Unreleased` changelog](https://github.com/ooaklee/lexr.sh/blob/main/CHANGELOG.md#020---unreleased) for a user-visible change, or this is an internal test or documentation-only change.
